...
class RegistrationPage extends StatefulWidget {
  ...
  const RegistrationPage({super.key, this.formData});
...
class _RegistrationPageState extends State<RegistrationPage> {
  ...
  void initState() {
    ...
    if (data != null) {
      ...
      _onBehalfOf = data['onBehalfOf'];
      if (data['profilePhoto'] != null && data['profilePhoto'] is File) {
        _imageFile = data['profilePhoto'];
      }
    }
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              value:
                                  _onBehalfOf != null &&
                                          _onBehalfOptions.contains(_onBehalfOf)
                                      ? _onBehalfOf
                                      : null,
                              decoration: const InputDecoration(
